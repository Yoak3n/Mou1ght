...
func UpdateMessagePosition(req *request.UpdateMessagePositionRequest, isAdmin bool) error {
	return instance.UseDatabase().UpdateMessagePosition(req.ID, req.Position, req.AuthorIP, isAdmin)
}
...
func ListMessages(dateRange *request.PostFilterDate, sort string) ([]*entity.MessageEntity, error) {
